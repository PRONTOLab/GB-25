...
compile_options = CompileOptions(; sync=true, raise=true, strip_llvm_debuginfo=true, strip=GordonBell25.parse_strip(parsed_args), multifloat=GordonBell25.multifloat_from_args(parsed_args), xla_debug_options=(xla_enable_enzyme_comms_opt=false,), optimize_communications=false)
